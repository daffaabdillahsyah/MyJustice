...
class InformasiDaerah extends StatefulWidget {
  const InformasiDaerah({Key? key}) : super(key: key);
  @override
  State<InformasiDaerah> createState() => _InformasiDaerahState();
}

class _InformasiDaerahState extends State<InformasiDaerah> {
  ...
  Widget _getMarker() {
    return Container(
      ...
      child: ClipOval(child: Image.asset("assets/profile2.png")),
    );
  }
