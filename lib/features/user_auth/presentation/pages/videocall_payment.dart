...
import 'video_call_method.dart';

class VideoCallRent extends StatelessWidget {
  final String name;
  final String avatarFileName;

  VideoCallRent({required this.name, required this.avatarFileName});
    ...
    return Card(
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: <Widget>[
            Text(
              'Jadwal Video Call (Disesuaikan oleh Pengacara)',
              style: TextStyle(
                fontSize: 18,
...
class LawyerBookingScreen extends StatelessWidget {
  ...
  LawyerBookingScreen(
      {required this.name,
      required this.avatarFileName}); // Add this constructor
      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            ...
            Text('Hukum Perdata, Hukum Pidana'),
            SizedBox(
              height: 20,
            ),
            Container(
                  ...
                  child: ElevatedButton(
                    onPressed: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => VideoCallMethod(
                            name: name,
                            avatarFileName: avatarFileName,
                          ),
                        ),
